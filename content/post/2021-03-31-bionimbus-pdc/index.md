...
1. [Setup and Logging In](#setup-and-logging-in)
1. [Creating a Virtual Machine](#creating-a-virtual-machine)
1. [Using S3 Storage](#using-s3-storage)

# Apply for a Bionimbus Account

1. First, you'll need a NIH eRA Commons account. That is administered through UChicago's University Research Administration, here is a link: [https://ura.uchicago.edu/page/era-commons](https://ura.uchicago.edu/page/era-commons) One of the questions they will ask is what role you will need in the Commons. Here's a link about the different roles: [https://era.nih.gov/files/eRA-Commons-Roles-10-2019.pdf](https://era.nih.gov/files/eRA-Commons-Roles-10-2019.pdf) 
1. After you have an eRA Commons account, Haky must give you "downloader" privileges in dbGaP.
1. Then, apply for access to Bionimbus: [https://bionimbus.opensciencedatacloud.org/pre_apply/?next=/apply/](https://bionimbus.opensciencedatacloud.org/pre_apply/?next=/apply/). For the question about "Describe your research [Public Abstract -- 500 words or less]", we've submitted variants of this in the past: "This research involves storing, querying and maintaining complex data from the UK Biobank. The data will be stored in a relational database hosted on Bionimbus. This study contains PII for over 500k people."
...
3. Log in to the bionimbus console:
[https://bionimbus-pdc.opensciencedatacloud.org/console/](https://bionimbus-pdc.opensciencedatacloud.org/console/)
...
Reference:
* https://www.opensciencedatacloud.org/support/ssh.html
* https://www.opensciencedatacloud.org/support/2fa.html
...
A quick explanation of the columns: 
 - `Memory_MB` is the amount of memory allocated to the VM 
 - `Disk` is the amount of disk storage mounted on `/` 
 - `Ephemeral` is the amount of disk storage mounted to a separate drive (usually `/mnt/`). This storage goes away if a snapshot is taken of the VM.
 - `VCPUs` is the number of CPUs allocated.
